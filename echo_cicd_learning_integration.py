...
class CICDAnalyzer:
    ...
    def analyze_success_patterns(self, metrics: List[CICDMetrics]) -> List[LearningPattern]:
        ...
        if success_coverage > failed_coverage + 10:  # 10% difference threshold
            patterns.append(LearningPattern(
                ...
                confidence=min(0.9, (success_coverage - failed_coverage) / 50),
        ...
        if success_security > failed_security + 15:  # 15 point difference
            patterns.append(LearningPattern(
                ...
                confidence=min(0.9, (success_security - failed_security) / 50),
    ...
    def analyze_performance_patterns(self, metrics: List[CICDMetrics]) -> List[LearningPattern]:
        ...
        slow_pipelines = [m for m in metrics if m.duration_seconds > slow_threshold]
    ...
    def analyze_temporal_patterns(self, metrics: List[CICDMetrics]) -> List[LearningPattern]:
        ...
        older_success_rate = sum(1 for m in older_metrics if m.success) / len(older_metrics)
...
class CICDLearningSystem:
    ...
    async def analyze_and_learn(self) -> List[LearningPattern]:
        ...
        for row in rows:
            ...
            metrics.append(CICDMetrics(
                ...
                target_environments=json.loads(data['target_environments']),
    ...
    async def apply_optimization(self, pattern_id: int, action_type: str, parameters: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if action_type == "increase_coverage_threshold":
                await self._update_coverage_threshold(parameters.get('new_threshold', 85))
    ...
    async def get_learning_insights(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'daily_trends': [{'date': row[0], 'success_rate': row[1]} for row in trends],
