...
class VideoGenerationSystem:
    ...
    def generate_video(self, prompt: str, method: str = 'auto', **kwargs) -> Dict:
        ...
        if method == 'auto':
            ...
            if os.path.exists("/home/patrick/Projects/ComfyUI-Working/custom_nodes/ComfyUI-AnimateDiff-Evolved/models/mm_sd_v15_v3.ckpt"):
                method = 'animatediff'
            else:
...
if __name__ == "__main__":
    ...
    test_video = "/home/patrick/Videos/goblin_slayer_30s.mp4"
