...
try:
    ...
    if status.status_code != 200:
        ...
        subprocess.Popen(["python3", "/home/patrick/Projects/ComfyUI-Working/main.py", "--listen", "0.0.0.0"], 
...
output_video = "/home/patrick/Videos/GOBLIN_SLAYER_ULTIMATE_WITH_PIPELINE.mp4"
...
""")
    ...
    subprocess.run(f"scp {output_video} patrick@192.168.50.100:/home/patrick/Videos/", shell=True)
