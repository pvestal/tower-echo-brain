#!/usr/bin/env python3
"""
TaskExecutionAgent - Autonomous Agent
...
class TaskExecutionAgent:
    """
    Agent specialized in executing complex multi-step tasks
    ...
    def __init__(self, echo_interface, tools):
        ...
        self.capabilities = ['task_decomposition', 'tool_coordination', 'result_synthesis']

    async def execute(self, task: Dict) -> Dict:
        """Execute a task using available tools and intelligence"""
        logger.info(f"🤖 TaskExecutionAgent executing task: {task.get('description', 'Unknown')}")
        ...
        try:
            ...
            logger.error(f"Error in TaskExecutionAgent: {e}")
            self.status = "error"
...
def create_taskexecutionagent(echo_interface, tools):
    """Create a new TaskExecutionAgent instance"""
    return TaskExecutionAgent(echo_interface, tools)
