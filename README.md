...
curl https://192.168.50.135/api/echo/models/list -k
```
...
```bash
# Service health
curl https://192.168.50.135/api/echo/health -k

# Model availability
curl https://192.168.50.135/api/echo/models/health -k

# Database connectivity
curl https://192.168.50.135/api/echo/db/health -k
```
...
# Clear model cache
curl -X POST https://192.168.50.135/api/echo/models/cache/clear -k
```
...
# Update statistics
psql -h 192.168.50.135 -U patrick -d tower_consolidated -c "ANALYZE;"
```
