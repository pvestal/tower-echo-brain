...
class EchoVoiceService:
    ...
    def check_ollama(self) -> bool:
        ...
        try:
            import requests
            response = requests.get("http://***REMOVED***:11434/", timeout=3)
    ...
    def check_music_service(self) -> bool:
        ...
        try:
            import requests
            response = requests.get("http://***REMOVED***:8080/api/services", timeout=3)
...
if __name__ == "__main__":
    ...
    logger.info("Voice interface: http://***REMOVED***:8311/")
    logger.info("WebSocket: ws://***REMOVED***:8311/ws")
