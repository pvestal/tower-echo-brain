...
from video_generation_system import VideoGenerationSystem, EchoBrainVideoIntegration
...
async def get_generation_status():
    ...
    models_status = {
        "animatediff": os.path.exists("***REMOVED***/ComfyUI-Working/custom_nodes/ComfyUI-AnimateDiff-Evolved/models/mm_sd_v15_v3.ckpt"),
        "svd": os.path.exists("***REMOVED***/ComfyUI-Working/models/checkpoints/svd_xt.safetensors"),
        "upscaling": os.path.exists("***REMOVED***/ComfyUI-Working/models/upscale_models/4x-UltraSharp.pth"),
