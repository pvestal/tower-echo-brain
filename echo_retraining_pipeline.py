...
class AutomatedRetrainingPipeline:
    ...
    async def _deploy_model(
        ...
        try:
            ...
            from echo_model_registry import ModelRegistryAPI, ModelType as RegistryModelType
    ...
    async def _start_ab_test(self, job: RetrainingJob, new_model_id: str) -> bool:
        ...
        try:
            from echo_ab_testing import ABTestingFramework, VariantConfig, MetricType
