...
async def test():
    try:
        from src.ingestion.fact_extractor import FactExtractor, OllamaClient
        print("✅ Classes imported successfully")
        
        # Create OllamaClient first
        print("Creating OllamaClient...")
        ollama_client = OllamaClient(ollama_host="http://localhost:11434")
