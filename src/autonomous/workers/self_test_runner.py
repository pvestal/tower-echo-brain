...
SELF_TESTS = [
    ...
    # ── v0.6.x tests ────────────────────────────────────────────────────
    {
        "name": "echo_brain_port",
        "query": "What port does Echo Brain run on?",
    ...
    },
    {
        ...
        "query": "What embedding model does Echo Brain use?",
        "expected_contains": ["nomic-embed-text"],
        "expected_not_contains": ["mxbai", "1024"],
        "endpoint": "/api/echo/ask",
        "method": "POST",
        "timeout_ms": 30000,
    },
    ...
    {
        "name": "framepack_gpu_memory",
        "query": "What gpu_memory_preservation value should FramePack use?",
        "expected_contains": ["6.0"],
    ...
    },
    {
        ...
        "query": "How does Echo Brain's hybrid search work?",
        "expected_contains": ["vector", "text"],
        "expected_not_contains": [],
        "endpoint": "/api/echo/ask",
        "method": "POST",
        "timeout_ms": 30000,
    },
    {
        "name": "graph_stats",
        "query": None,
        "expected_contains": ["nodes"],
        "expected_not_contains": [],
        "endpoint": "/api/echo/graph/stats",
        "method": "GET",
        "timeout_ms": 5000,
    },
    {
        ...
        "query": None,
        "expected_contains": ["total_facts"],
        "expected_not_contains": [],
        "endpoint": "/api/echo/knowledge/stats",
        "method": "GET",
        "timeout_ms": 5000,
    },
    {
        "name": "voice_status",
        "query": None,
        "expected_contains": ["stt", "tts"],
        "expected_not_contains": [],
        "endpoint": "/api/echo/voice/status",
        "method": "GET",
        "timeout_ms": 5000,
    },
]
