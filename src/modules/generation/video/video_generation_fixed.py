...
class VideoGenerationSystemFixed:
    ...
    def __init__(self, comfyui_url="http://localhost:8188"):
        ...
        self.output_dir = Path(f"/home/{os.getenv('TOWER_USER', 'patrick')}/Videos")
    ...
    def generate_ffmpeg_video(self, image_path: str, duration: int = 30) -> str:
        ...
        if not os.path.exists(image_path):
            ...
            test_images = [
                f"/home/{os.getenv('TOWER_USER', 'patrick')}/Projects/ComfyUI-Working/output/goblin_solo_00001_.png",
                f"/home/{os.getenv('TOWER_USER', 'patrick')}/Projects/ComfyUI-Working/output/video_base_00001_.png"
            ]
    ...
    def generate_video_from_prompt(self, prompt: str, duration: int = 30) -> Dict:
        ...
        if not image_path:
            ...
            image_path = f"/home/{os.getenv('TOWER_USER', 'patrick')}/Projects/ComfyUI-Working/output/goblin_solo_00001_.png"
