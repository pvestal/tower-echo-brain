...
class TowerPlaidSSO:
    ...
    async def create_authenticated_link_session(self, user_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'link_url': f"https://192.168.50.135/plaid/link/{session_id}",
        ...
        async with aiohttp.ClientSession() as session:
            try:
                ...
                auth_data = {
                    ...
                    'redirect_uri': f"https://192.168.50.135/plaid/callback/{session_id}"
                }
    ...
    async def _create_plaid_link_token(self, user_id: str, session_id: str) -> Dict[str, Any]:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            data = {
                ...
                "country_codes": ["US"],
                "language": "en",
                "webhook": f"https://192.168.50.135/api/plaid/webhook/{session_id}",
                "link_customization_name": "default",
                "redirect_uri": f"https://192.168.50.135/plaid/success/{session_id}"
            }
